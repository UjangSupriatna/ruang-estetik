      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <FadeInOnScroll>
          <div className="text-center mb-12 sm:mb-16">
            <div className="inline-flex items-center justify-center size-12 rounded-xl bg-silver-50 dark:bg-silver-900/20 mb-5">
              <MessageCircleQuestion className="size-6 text-silver-600 dark:text-silver-400" />
            </div>
            <h2
            ...
            <div className="mt-6 mx-auto w-16 h-1 rounded-full bg-silver-500 dark:bg-silver-400" />
          </div>
        </FadeInOnScroll>
        ...
        <FadeInOnScroll delay={0.3}>
          <div className="mt-12 sm:mt-16 text-center">
            ...
            <a
              href="#kontak"
              className="inline-flex items-center gap-2 rounded-lg bg-silver-500 px-6 py-3 text-sm font-semibold text-white shadow-md shadow-silver-500/20 transition-all duration-200 hover:bg-silver-600 hover:shadow-silver-600/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-silver-500 focus-visible:ring-offset-2"
            >
              Hubungi Kami
            </a>
          </div>
