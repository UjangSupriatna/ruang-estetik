      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <FadeInOnScroll>
          <div className="text-center mb-12 sm:mb-16">
            <div className="inline-flex items-center justify-center size-12 rounded-xl bg-amber-100 dark:bg-amber-900/20 mb-5">
              <MessageCircleQuestion className="size-6 text-amber-700 dark:text-amber-400" />
            </div>
            <h2
            ...
            <div className="mt-6 mx-auto w-16 h-1 rounded-full bg-amber-600 dark:bg-amber-500" />
          </div>
        </FadeInOnScroll>
          ...
          <Accordion type="single" collapsible className="w-full">
            {faqItems.map((item) => (
              <StaggerItem key={item.id}>
                <AccordionItem
                  value={item.id}
                  className="border-border/60 group rounded-xl mb-3 overflow-hidden transition-colors data-[state=open]:bg-amber-50/60 dark:data-[state=open]:bg-amber-950/20 data-[state=open]:border-amber-200/50 dark:data-[state=open]:border-amber-800/30 data-[state=closed]:bg-card data-[state=closed]:hover:bg-muted/30"
                >
                  <AccordionTrigger className="px-5 sm:px-6 py-4 sm:py-5 text-base sm:text-lg font-semibold text-foreground hover:no-underline data-[state=open]:text-amber-700 dark:data-[state=open]:text-amber-400 [&>svg]:text-muted-foreground data-[state=open]:[&>svg]:text-amber-600 dark:data-[state=open]:[&>svg]:text-amber-400">
                    {item.question}
                  </AccordionTrigger>
        ...
        <FadeInOnScroll delay={0.3}>
          <div className="mt-12 sm:mt-16 text-center">
            ...
            <a
              href="#kontak"
              className="inline-flex items-center gap-2 rounded-lg bg-amber-600 px-6 py-3 text-sm font-semibold text-white shadow-md shadow-amber-600/20 transition-all duration-200 hover:bg-amber-700 hover:shadow-amber-700/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-600 focus-visible:ring-offset-2"
            >
              Hubungi Kami
            </a>
          </div>
