          ...
          {services.map((service) => {
            ...
            return (
              <motion.div key={service.title} variants={cardVariants}>
                <Card className="group overflow-hidden border-border/60 bg-card py-0 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-neutral-900/10 dark:hover:shadow-silver-500/5">
                  {/* Image */}
                  ...
                  <CardContent className="relative px-5 pb-6 pt-0">
                    ...
                    <div className="-mt-8 mb-4 flex">
                      <div className="flex h-14 w-14 items-center justify-center rounded-full bg-silver-500 shadow-lg shadow-silver-500/30 transition-transform duration-300 group-hover:scale-110">
                    ...
                    <a
                      href="#"
                      className="inline-flex items-center gap-1 text-sm font-semibold text-silver-500 dark:text-silver-400 transition-colors duration-200 hover:text-silver-600 dark:hover:text-silver-300"
                    >
